...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('anarapp_videopiedra', 'autory',
                      self.gf('anarapp.models.CharField')(default=None, max_length=65000, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'PeliculaPiedra.anioyp'
        db.add_column('anarapp_peliculapiedra', 'anioyp',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PeliculaPiedra.anioyp'
        db.delete_column('anarapp_peliculapiedra', 'anioyp')
    ...
    models = {
        ...
        'anarapp.peliculapiedra': {
            ...
            'anioyp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'archivoy': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
