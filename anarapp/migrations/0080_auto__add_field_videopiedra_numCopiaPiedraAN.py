...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoPiedra.numCopiaPiedraAN'
        db.add_column('anarapp_videopiedra', 'numCopiaPiedraAN',
                      self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoPiedra.numCopiaPiedraAN'
        db.delete_column('anarapp_videopiedra', 'numCopiaPiedraAN')
