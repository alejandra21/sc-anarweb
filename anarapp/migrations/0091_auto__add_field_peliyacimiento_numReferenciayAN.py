...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeliYacimiento.numReferenciayAN'
        db.add_column('anarapp_peliyacimiento', 'numReferenciayAN',
                      self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeliYacimiento.numReferenciayAN'
        db.delete_column('anarapp_peliyacimiento', 'numReferenciayAN')
