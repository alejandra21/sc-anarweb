...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoYacimiento.numReferenciayAN'
        db.add_column('anarapp_videoyacimiento', 'numReferenciayAN',
                      self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoYacimiento.numReferenciayAN'
        db.delete_column('anarapp_videoyacimiento', 'numReferenciayAN')
