...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Foto.numCopiaAnarFotoAN'
        db.add_column('anarapp_foto', 'numCopiaAnarFotoAN',
                      self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Foto.numCopiaAnarFotoAN'
        db.delete_column('anarapp_foto', 'numCopiaAnarFotoAN')
