...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoPiedra.autory'
        db.alter_column('anarapp_videopiedra', 'autory', self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True))

        # Changing field 'VideoPiedra.instituciony'
        db.alter_column('anarapp_videopiedra', 'instituciony', self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True))

        # Changing field 'VideoPiedra.anioy'
        db.alter_column('anarapp_videopiedra', 'anioy', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

        # Changing field 'VideoPiedra.tituloy'
        db.alter_column('anarapp_videopiedra', 'tituloy', self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True ))

        # Changing field 'VideoPiedra.formatoy'
        db.alter_column('anarapp_videopiedra', 'formatoy', self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True))
        # Adding field 'PeliculaPiedra.anioy'
        db.alter_column('anarapp_peliculapiedra', 'anioy',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))


        # Changing field 'PeliculaPiedra.autory'
        db.alter_column('anarapp_peliculapiedra', 'autory', self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True))

        # Changing field 'PeliculaPiedra.tituloy'
        db.alter_column('anarapp_peliculapiedra', 'tituloy', self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True))

        # Changing field 'PeliculaPiedra.instituciony'
        db.alter_column('anarapp_peliculapiedra', 'instituciony', self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True))

        # Changing field 'PeliculaPiedra.formatoy'
        db.alter_column('anarapp_peliculapiedra', 'formatoy', self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True))

        # Changing field 'PeliculaPiedra.numReferenciay'
        db.alter_column('anarapp_peliculapiedra', 'numReferenciay', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

    def backwards(self, orm):

        # Changing field 'VideoPiedra.autory'
        db.alter_column('anarapp_videopiedra', 'autory', self.gf('anarapp.models.CharField')(default='', max_length=65000, null=True, blank=True))

        # Changing field 'VideoPiedra.instituciony'
        db.alter_column('anarapp_videopiedra', 'instituciony', self.gf('anarapp.models.CharField')(default='', max_length=65000, null=True, blank=True))

        # Changing field 'VideoPiedra.anioy'
        db.alter_column('anarapp_videopiedra', 'anioy', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True))

        # Changing field 'VideoPiedra.tituloy'
        db.alter_column('anarapp_videopiedra', 'tituloy', self.gf('anarapp.models.CharField')(default='', max_length=65000, null=True, blank=True))

        # Changing field 'VideoPiedra.formatoy'
        db.alter_column('anarapp_videopiedra', 'formatoy', self.gf('anarapp.models.CharField')(default='', max_length=65000, null=True, blank=True))
        # Deleting field 'PeliculaPiedra.anioy'
        #db.delete_column('anarapp_peliculapiedra', 'anioy')


        # Changing field 'PeliculaPiedra.autory'
        db.alter_column('anarapp_peliculapiedra', 'autory', self.gf('anarapp.models.CharField')(default='', max_length=65000, null=True, blank=True))

        # Changing field 'PeliculaPiedra.tituloy'
        db.alter_column('anarapp_peliculapiedra', 'tituloy', self.gf('anarapp.models.CharField')(default='', max_length=65000, null=True, blank=True))

        # Changing field 'PeliculaPiedra.instituciony'
        db.alter_column('anarapp_peliculapiedra', 'instituciony', self.gf('anarapp.models.CharField')(default='', max_length=65000, null=True, blank=True))

        # Changing field 'PeliculaPiedra.formatoy'
        db.alter_column('anarapp_peliculapiedra', 'formatoy', self.gf('anarapp.models.CharField')(default='', max_length=65000, null=True, blank=True))

        # Changing field 'PeliculaPiedra.numReferenciay'
        db.alter_column('anarapp_peliculapiedra', 'numReferenciay', self.gf('django.db.models.fields.IntegerField')(default='', null=True, blank=True))
    ...
    models = {
        ...
        'anarapp.videopiedra': {
            ...
            'anioy': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'archivoy': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'autory': ('anarapp.models.CharField', [], {'default': 'None', 'max_length': '65000', 'null': 'True', 'blank': 'True'}),
            'formatoy': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True', 'blank': 'True'}),
            'instituciony': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True', 'blank': 'True'}),
            'isFromAnary': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'isvidyac': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'anarapp.videoyacimiento': {
            ...
            'anioy': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'archivoy': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'autory': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True', 'blank': 'True'}),
            'formatoy': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True', 'blank': 'True'}),
            'instituciony': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True', 'blank': 'True'}),
            ...
            'isvidyac': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'numCopiayac': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'numReferenciay': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'tituloy': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True', 'blank': 'True'}),
            'video_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['anarapp.Video']", 'unique': 'True', 'primary_key': 'True'}),
