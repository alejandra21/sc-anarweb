...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeliculaPiedra.numCopiaPiedraAN'
        db.add_column('anarapp_peliculapiedra', 'numCopiaPiedraAN',
                      self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeliculaPiedra.numCopiaPiedraAN'
        db.delete_column('anarapp_peliculapiedra', 'numCopiaPiedraAN')
    ...
    models = {
        ...
        'anarapp.piedra': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True'}),
