...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('anarapp_piedra', 'nombre', self.gf('anarapp.models.CharField')(max_length=65000, null=True))

    def backwards(self, orm):

        # Changing field 'Piedra.nombre'
        db.alter_column('anarapp_piedra', 'nombre', self.gf('anarapp.models.CharField')(default='', max_length=65000))
