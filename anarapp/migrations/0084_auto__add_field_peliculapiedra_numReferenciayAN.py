...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeliculaPiedra.numReferenciayAN'
        db.add_column('anarapp_peliculapiedra', 'numReferenciayAN',
                      self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeliculaPiedra.numReferenciayAN'
        db.delete_column('anarapp_peliculapiedra', 'numReferenciayAN')
