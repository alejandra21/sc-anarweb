...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoYacimiento.numCopiaANyac'
        db.delete_column('anarapp_videoyacimiento', 'numCopiaANyac')

        # Adding field 'VideoYacimiento.numCopiaANy'
        db.add_column('anarapp_videoyacimiento', 'numCopiaANy',
                      self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VideoYacimiento.numCopiaANyac'
        db.add_column('anarapp_videoyacimiento', 'numCopiaANyac',
                      self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'VideoYacimiento.numCopiaANy'
        db.delete_column('anarapp_videoyacimiento', 'numCopiaANy')
