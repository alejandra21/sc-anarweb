...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeliYacimiento.numCopiayacAN'
        db.add_column('anarapp_peliyacimiento', 'numCopiayacAN',
                      self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeliYacimiento.numCopiayacAN'
        db.delete_column('anarapp_peliyacimiento', 'numCopiayacAN')
